...
mixinsList.forEach(function(file) {
  file = path.basename(file, '.js');
  externals[`element-ui-kr2/src/mixins/${file}`] = `element-ui-kr2/lib/mixins/${file}`;
});
transitionList.forEach(function(file) {
  file = path.basename(file, '.js');
  externals[`element-ui-kr2/src/transitions/${file}`] = `element-ui-kr2/lib/transitions/${file}`;
});
